...
//   /* your full RTX-style card CSS here */
//   .product-container {
//     position: relative;
//   }
//   .card {
...
//     position: absolute; max-width: 120%;
//     top: -150%; transition: .6s;
//   }
//   .card:hover .bg-title {
...
//     text-align: center; transition: 1s; z-index: 5;
//   }
//   .card:hover .content {
//     height: 220px;
//   }
...
//   }
//   .card:hover .feature {
//     visibility: visible; opacity: 1; transition-delay: .5s;
//   }
//   .feature div {
...
//     transition: 0.5s; cursor: pointer; outline: none;
...
//     z-index: 1;
//   }
//   /* Orange Arc/Circle at the top */
//   .card:before {
//     content: '';
//     position: absolute;
//     top: -80px; left: -80px;
//     width: 260px; height: 260px;
//     background: radial-gradient(circle at 60% 40%, #ff8100 80%, #ffdc52 100%);
//     border-radius: 50%;
//     z-index: 1;
//     opacity: 0.95;
//     transition: opacity 0.3s;
//     box-shadow: 0 4px 32px #ff810055;
//   }
//   .card:hover {
//     transform: translateY(-10px) scale(1.03);
//     box-shadow: 0 16px 48px 0 #ff8100cc, 0 2px 16px #ffdc52aa;
//     border: 2px solid #ff8100;
//   }
//   .card:hover:before {
//     opacity: 1;
...
//     transition: 1s;
//     z-index: 5;
//     background: linear-gradient(0deg, rgba(34,34,34,0.98) 80%, rgba(34,34,34,0.0) 100%);
//     border-bottom-left-radius: 22px;
//     border-bottom-right-radius: 22px;
//     box-shadow: 0 -2px 16px #ff810022;
//     display: flex;
...
//     color: #ffdc52;
//     font-weight: 500;
//     text-shadow: 0 1px 4px #ff8100aa;
//     z-index: 2;
//   }
//   .card:hover .feature {
//     visibility: visible;
...
//     cursor: pointer;
//   }
//   .btn-buy1:hover { background: #ff4d4d; color: #fff; transform: scale(1.08);}
//   .btn-buy2:hover { background: #ffaa00; color: #fff; transform: scale(1.08);}
//   .btn-buy0:hover { background: #4CAF50; color: #fff; transform: scale(1.08);}
//   /* Responsive */
//   @media (max-width: 700px) {
//     .card { width: 98vw; }
//     .bg-title { font-size: 4em; }
//   }
// `;
